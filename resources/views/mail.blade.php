        ...
        <div class="col-11 col-md-6" style="box-sizing: border-box;flex: 0 0 auto;width: 50%;">
            ...
            <div class="card mt-5 px-2 border-0" style="box-sizing: border-box;position: relative;display: flex;flex-direction: column;min-width: 0;word-wrap: break-word;background-color: #fff;background-clip: border-box;border: 0!important;border-radius: .25rem;margin-top: 3rem!important;padding-right: .5rem!important;padding-left: .5rem!important;">
                <div class="card-body" style="box-sizing: border-box;flex: 1 1 auto;padding: 1rem 1rem;">
                    ...
                    <p style="box-sizing: border-box;margin-top: 0;margin-bottom: 1rem;font-family: 'Lora', serif;">Permohonan registrasi Anda telah disetujui.</p>
                    <p style="box-sizing: border-box;margin-top: 0;margin-bottom: 1rem;font-family: 'Lora', serif;">Sekarang Anda dapat masuk ke akun Anda dan mendapatkan akses fitur dari Aplikasi Helpdesk.</p>
                    <div class="text-center my-5" style="box-sizing: border-box;margin-top: 3rem!important;margin-bottom: 3rem!important;text-align: center!important;">
                        <a href="{{env('WEBHOOK_URL')}}/login" target="_blank" class="btn btn-custom-primary" style="box-sizing: border-box;color: #ffffff;text-decoration: none;display: inline-block;font-weight: 400;line-height: 1.5;text-align: center;vertical-align: middle;cursor: pointer;-webkit-user-select: none;-moz-user-select: none;user-select: none;background-color: #4993FA;border: 1px solid transparent;padding: 12px 20px;font-size: 1rem;border-radius: 2rem;transition: color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;border-color: #4993FA;font-family: 'Roboto', sans-serif;">Login Sekarang</a>
                    </div>
